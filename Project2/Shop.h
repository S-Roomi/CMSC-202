...
class Shop{
 public:
  ...
  int CheckIngredient(Ingredient ingredient);
  ...
  void IncrementQuantity(Ingredient ingredient);
  ...
  bool DecrementQuantity(Ingredient ingredient);
  ...
  bool CheckQuantity(Ingredient ingredient1, Ingredient ingredient2);
  ...
  Ingredient GetIngredient(int x);
